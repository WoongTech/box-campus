...
- image를 넣을 수 있는 경우만: 그 핵심 문장이 가리키는 도식·표·원문 캡처. 장식용 스톡 사진, 발표 제목 슬라이드, YouTube/강의 표지 썸네일, 글과 무관한 제품 스크린샷은 금지
- image 형식: { src, alt }. src는 확인한 https만. alt는 그 그림이 무엇인지 한 줄. 주소를 지어내지 마세요. img.youtube.com·i.ytimg.com 썸네일은 넣지 마세요
- 카드 id는 모두 달라야 함
