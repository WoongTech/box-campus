...
export const neutralTheme = defineTheme({
  ...
  // Typography: Pretendard first so Korean body text has a face.
  // Figtree stays in the fallback list for Latin. Scale: base=14, ratio=1.2.
  typography: {
  ...
  // Motion: snappier than the Neutral default.
