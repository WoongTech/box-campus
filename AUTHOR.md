...
`image`는 핵심 슬라이드에만 선택이며, 대부분은 없다. 문장이 그 그림을 말할 때만 붙인다. 장식용 스톡 사진, 발표·강의 표지 썸네일, YouTube 썸네일, 글과 무관한 제품 스크린샷은 넣지 않는다. 질문·고칠 문장·비유 슬라이드의 사진은 무시된다.
...
- 사진은 기본으로 넣지 말 것. 문장이 가리키는 도식·표·원문 캡처만 image: { src: "https://...", alt: "설명" }. 장식 사진·무관한 스크린샷·YouTube/강의 표지 썸네일·지어낸 주소 금지
- 하루 분량·멈춤 필드는 넣지 말 것
